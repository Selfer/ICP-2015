...
"Pouziti: labyrint velikost_planu pocet_hracu pocet_predmetu\n"
"         labyrint ulozena_hra\n"
"Popis parametru:\n"
"\tvelikost_planu - velikost herniho planu je 5,7,9 nebo 11 poli.\n"
"\tpocet_hracu - hra je urcena pro 2-4 hracu.\n"
"\tpocet_predmedtu - pocet predmetu rozmistenych na hernim planu (12 nebo 24)\n"
...
int main(int argc, char *argv[]) {
    ...
    string posunuti;
    HerniPlan plan;
    plan.inicializace(velikost, pocetPredmetu, pocetBodu);
    ...
    while(1){
        ...
        //ukaze hraci hledany predmet
            ...
            for(int i = 0; i < pocetHracu; i++){
                ...
                hrac[i] = Hrac(x,y,predmet,body);
            }
            int vel, pocBodu, pocPredmetu;
            string vlPolicko;
            soubor >> vel >> pocPredmetu >> pocBodu >> vlPolicko;
            //nastaveni velikosti a volneho policka
            plan.inicializace_ulozena(vel, pocPredmetu,pocBodu);
